        ...
        <ModalBody>
          <Form>
            ...
            <legend>
              ...
              <FormGroup check>
                <Input data-tk value="yes" name="radio1" type="radio"/>
                {' '}
                <Label check>
                  There was plent of stock.
                </Label>
              </FormGroup>
              <FormGroup check>
                <Input data-tk value="no" name="radio1" type="radio"/>
                {' '}
                <Label check>
            ...
            <legend>
              ...
              <FormGroup check>
                ...
                {' '}
                <Label check>
                  I was seen without an appointment.
                </Label>
              </FormGroup>
              <FormGroup check>
                ...
                {' '}
                <Label check>
                  Wait times are too long at this location.
                </Label>
              </FormGroup>
            </FormGroup>
            <FormGroup>
            ...
            <Button block type="primary" onClick={this.submitResponse}>Submit Response</Button>
          </Form>
        </ModalBody>
      </Modal>
    );
